...
/**
 * A drawer based layout for the dnsclms theme.
 *
...
$templatecontext = [
    ...
    'headerbuttons' => \theme_dnsclms\util\extras::get_mypublic_headerbuttons($context, $user),
    'editprofileurl' => \theme_dnsclms\util\extras::get_mypublic_editprofile_url($user, $courseid),
...
$themesettings = new \theme_dnsclms\util\settings();

$templatecontext = array_merge($templatecontext, $themesettings->footer());

echo $OUTPUT->render_from_template('theme_dnsclms/mypublic', $templatecontext);
