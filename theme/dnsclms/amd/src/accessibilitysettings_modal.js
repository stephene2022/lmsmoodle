    ...
    function(jQuery, Notification, CustomEvents, Modal, ModalRegistry, Ajax) {
        ...
        var AccessibilityModal = function(root) {
            ...
            var request = Ajax.call([{
                methodname: 'theme_dnsclms_getthemesettings',
                args: {}
            }]);
        ...
        AccessibilityModal.TYPE = 'theme_dnsclms-themesettings_modal';
        ...
        AccessibilityModal.prototype.registerEventListeners = function() {
            ...
            this.getModal().on(CustomEvents.events.activate, SELECTORS.SAVE_BUTTON, function() {
                var request = Ajax.call([{
                    methodname: 'theme_dnsclms_savethemesettings',
                    args: {
        ...
        if (!registered) {
            ModalRegistry.register(AccessibilityModal.TYPE, AccessibilityModal, 'theme_dnsclms/accessibilitysettings_modal');
            registered = true;
        }
