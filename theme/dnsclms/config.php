...
$THEME->scss = function($theme) {
    return theme_dnsclms_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_dnsclms_get_extra_scss';
$THEME->prescsscallback = 'theme_dnsclms_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_dnsclms_get_precompiled_css';
$THEME->yuicssmodules = [];
