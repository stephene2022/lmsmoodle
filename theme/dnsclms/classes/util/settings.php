...
class settings {
    ...
    public function __construct() {
        $this->theme = theme_config::load('dnsclms');
    }
    ...
    public function frontpage_slideshow() {
        ...
        $defaultimage = new \moodle_url('/theme/dnsclms/pix/default_slide.jpg');
    ...
    public function frontpage_marketingboxes() {
        if ($templatecontext['displaymarketingbox'] = $this->displaymarketingbox) {
            ...
            $defaultimage = new \moodle_url('/theme/dnsclms/pix/default_markegingicon.svg');
