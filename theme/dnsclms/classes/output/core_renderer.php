...
namespace theme_dnsclms\output;

use theme_config;
use context_course;
use moodle_url;
use html_writer;
use theme_dnsclms\output\core_course\activity_navigation;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function standard_head_html() {
        ...
        $theme = theme_config::load('dnsclms');
    ...
    public function body_attributes($additionalclasses = array()) {
        $hasaccessibilitybar = get_user_preferences('themednsclmssettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themednsclmssettings_fonttype', '');
        if ($fonttype) {
    ...
    public function get_navbar_callbacks_data() {
        $callbacks = get_plugins_with_function('dnsclms_additional_header', 'lib.php');
